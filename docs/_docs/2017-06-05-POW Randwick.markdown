...
| 11 | GENERAL ARRANGEMENT DRAWING - 1:200 AT HOSPITAL TOWER | 11B - SERIES - GA PLANS 1 TO 200, 11L - SERIES - FIRE COMPARTMENT PLANS ([Fire](#Fire Compartments)), 11S - SERIES ROOM LAYOUT SHEET PLANS, 11U - SERIES TENNANCY DRAWINGS | DWG.HSP.ARC.BB.XXX.00.001 (GA's),  |
...
| 58 | SIGNAGE | 58B - SERIES WAY FINDING, 58T - SERIES STATUTORY SIGNAGE| |
